...
sel_aqMet: Donna
selRegionsIDS: East Kootenay - north including Invermere, East
  Kootenay - south including Cranbrook
smokeDuration: 24-48 hours
...
The next update will be available on May 01, 2025.

The Air Quality Warning for wildfire smoke can be accessed online at
<https://bcgov.github.io/aqwarnings/>.

![A description of Region(s) included in the Air Quality Warning for
wildfire smoke is provided at the end of this page. The Air Quality
Warning for wildfire smoke does not include Metro Vancouver or the
Fraser Valley Regional
District.](map_html.png){fig-alt="Air Quality Warning - Wildfire Smoke Regions for April 30, 2025: East Kootenay (North), East Kootenay (South)."
width="100%"}
